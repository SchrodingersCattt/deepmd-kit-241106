...
def task_deriv_one(
    ...
    if do_virial:
        ...
        # debug
        nloc = 5
        nall = extended_force.shape[1]
        assert extended_virial.shape[1] == nall
        virial = extended_virial[:,:nloc]
        virial_2 = extended_virial[:,nloc:]
        force = extended_force[:,:nloc]
        force_2 = extended_force[:,nloc:]
